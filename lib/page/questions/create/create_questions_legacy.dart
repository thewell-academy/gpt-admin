...
//
// class CreateQuestionPageLegacy extends StatefulWidget {
//   const CreateQuestionPageLegacy({super.key});
//
//   @override
//   State<StatefulWidget> createState() => _CreateQuestionLegacyState();
// }
//
// class _CreateQuestionLegacyState extends State<CreateQuestionPageLegacy> {
//
//   List<String> options = ["수능/모의고사", "내신"];
//   String? selectedOption;
//
//   String? _selectedSubject; // State variable for selected subject
//   final List<QuestionRouterState> _questionPages = []; // List of question page states
//
...
//         _questionPages.add(QuestionRouterState(
...
//       List<QuestionRouterState> questionPages,
...
//           .toList();
//
//       List<QuestionRouterState> replaceCandidatesList = replaceCandidateIndexList
...
//                   List<QuestionRouterState> replaceSelectedList = replaceCandidatesList
//                       .where((page) {
//                     int questionId = page.questionId;
