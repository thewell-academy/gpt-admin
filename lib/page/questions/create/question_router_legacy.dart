...
class QuestionPageLegacy extends StatefulWidget {
  ...
  @override
  State<QuestionPageLegacy> createState() => _QuestionPageLegacyStateWidget();
}

class _QuestionPageLegacyStateWidget extends State<QuestionPageLegacy> {
