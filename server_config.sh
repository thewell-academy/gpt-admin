...
if [[ "$BRANCH_NAME" == "main" ]]; then
  THEWELL_GPT_SERVER_URL="//thewell-gpt-lb-101888234.ap-northeast-2.elb.amazonaws.com"
else
...
String get gptServerUrl {
  const String defaultUrl = '//thewell-gpt-lb-101888234.ap-northeast-2.elb.amazonaws.com';
